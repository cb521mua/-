  ...
  async tijiao2(biaodan){
    ...
    if(Imgs.length!=0){
      ...
      for(var i=0;i<Imgs.length;i++){
        ...
        //拼接云路径
        fileID[i]="cloud://cloud1-1gtn3g544c417fd6.636c-cloud1-1gtn3g544c417fd6-1311218075/ss_img/"+app.userInfo._id+"-"+time.toString()+"-"+i.toString()+".jpg"
        wx.cloud.uploadFile({
          cloudPath: "ss_img/"+app.userInfo._id+"-"+time+"-"+i.toString()+".jpg", // 上传至云端的路径
